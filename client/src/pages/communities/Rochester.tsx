          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6">
                Rochester is a thriving community located just 10 miles west of Rochester on 
                Highway 14. Known for its excellent school system and family-friendly 
                atmosphere, Rochester has experienced significant growth in recent years.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                ...
                Rochester's growing commercial district provides local shopping and services.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700">Award-winning Rochester Public Schools</span>
                </div>
                <div className="flex items-center gap-3">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between border-b border-gray-200 pb-2">
                  ...
                  <span className="font-semibold text-[#1d3557]">Rochester Public Schools</span>
                </div>
                <div className="flex justify-between border-b border-gray-200 pb-2">
